...
public class RandomPentachoron {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    PrintStream ecurvature = new PrintStream(
        "src/Experiments/pentachoron_ecurvature.txt");
    PrintStream vcurvature = new PrintStream(
        "src/Experiments/pentachoron_vcurvature.txt");
    PrintStream lehr = new PrintStream("src/Experiments/pentachoron_lehr.txt");
    PrintStream vehr = new PrintStream("src/Experiments/pentachoron_vehr.txt");
    ...
    TriangulationIO
        .readTriangulation("Data/Triangulations/CommonManifolds/pentachoron_regular.xml");
