...
public class BreadCrumbs {
	 ...
	 * addMarker
	 * 
	 * This method is responsible for adding crumbs to the handler and
	 * determining when crumbs should become invisible. Right now, crumbs are
	 * removed once there are more than 20 markers in the handler. Crumbs are
	 * removed according to when they were placed on the manifold by the user.
	 *********************************************************************************/
