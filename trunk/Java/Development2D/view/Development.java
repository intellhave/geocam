...
public class Development {
  ...
  private Marker sourceMarker; //fixed marker at source point
  ...
  public Development(ManifoldPosition sourcePoint, int depth, double radius) {
    ...
    maxDepth = depth;
    source = sourcePoint;
    sourceMarker = new Marker(source, new MarkerAppearance());
    rebuild();
  }
  ...
  public Marker getSourceMarker() { return sourceMarker; }
