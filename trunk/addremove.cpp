...
{
     Triangulation::vertexTable[s1.getIndex()].addVertex(s2.getIndex());
     Triangulation::vertexTable[s2.getIndex()].addVertex(s1.getIndex());
}
void add(Vertex s1, Edge s2)
{
     Triangulation::vertexTable[s1.getIndex()].addEdge(s2.getIndex());
     Triangulation::edgeTable[s2.getIndex()].addVertex(s1.getIndex());
}
void add(Vertex s1, Face s2)
{
     Triangulation::vertexTable[s1.getIndex()].addFace(s2.getIndex());
     Triangulation::faceTable[s2.getIndex()].addVertex(s1.getIndex());
}
void add(Vertex s1, Tetra s2)
{
     Triangulation::vertexTable[s1.getIndex()].addTetra(s2.getIndex());
     Triangulation::tetraTable[s2.getIndex()].addVertex(s1.getIndex());
}
void add(Edge s1, Vertex s2)
{
     Triangulation::edgeTable[s1.getIndex()].addVertex(s2.getIndex());
     Triangulation::vertexTable[s2.getIndex()].addEdge(s1.getIndex());
}
void add(Edge s1, Edge s2)
{
     Triangulation::edgeTable[s1.getIndex()].addEdge(s2.getIndex());
     Triangulation::edgeTable[s2.getIndex()].addEdge(s1.getIndex());
}
void add(Edge s1, Face s2)
{
     Triangulation::edgeTable[s1.getIndex()].addFace(s2.getIndex());
     Triangulation::faceTable[s2.getIndex()].addEdge(s1.getIndex());
}
void add(Edge s1, Tetra s2)
{
     Triangulation::edgeTable[s1.getIndex()].addTetra(s2.getIndex());
     Triangulation::tetraTable[s2.getIndex()].addEdge(s1.getIndex());
}
void add(Face s1, Vertex s2)
{
     Triangulation::faceTable[s1.getIndex()].addVertex(s2.getIndex());
     Triangulation::vertexTable[s2.getIndex()].addFace(s1.getIndex());
}
void add(Face s1, Edge s2)
{
     Triangulation::faceTable[s1.getIndex()].addEdge(s2.getIndex());
     Triangulation::edgeTable[s2.getIndex()].addFace(s1.getIndex());
}
void add(Face s1, Face s2)
{
     Triangulation::faceTable[s1.getIndex()].addFace(s2.getIndex());
     Triangulation::faceTable[s2.getIndex()].addFace(s1.getIndex());
}
void add(Face s1, Tetra s2)
{
     Triangulation::faceTable[s1.getIndex()].addTetra(s2.getIndex());
     Triangulation::tetraTable[s2.getIndex()].addFace(s1.getIndex());
}
void add(Tetra s1, Vertex s2)
{
     Triangulation::tetraTable[s1.getIndex()].addVertex(s2.getIndex());
     Triangulation::vertexTable[s2.getIndex()].addTetra(s1.getIndex());
}
void add(Tetra s1, Edge s2)
{
     Triangulation::tetraTable[s1.getIndex()].addEdge(s2.getIndex());
     Triangulation::edgeTable[s2.getIndex()].addTetra(s1.getIndex());
}
void add(Tetra s1, Face s2)
{
     Triangulation::tetraTable[s1.getIndex()].addFace(s2.getIndex());
     Triangulation::faceTable[s2.getIndex()].addTetra(s1.getIndex());
}
void add(Tetra s1, Tetra s2)
{
     Triangulation::tetraTable[s1.getIndex()].addTetra(s2.getIndex());
     Triangulation::tetraTable[s2.getIndex()].addTetra(s1.getIndex());
}
