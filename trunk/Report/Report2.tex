...
\begin{figure}
\includegraphics[scale = 0.6]{SphG0V10.png}
...
In hyperbolic geometry, we encounter a new background that has properties both similar and distinct from Euclidean and spherical systems. Please see Fig.~\ref{PD} for an illustration of the hyperbolic plane. This notion of a hyperbolic plane can also be seen in popular art, particularly M.C. Escher's ``Circle Limit'' series, which includes some of his most famous pieces including the ``Angels and Devils'' picture. \newline
