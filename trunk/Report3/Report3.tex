...
While we are highly optimistic about verifying our conjectures, we are still in the development process of our code and feel that there are a few issues that must be straightened out. We are confident that we can figure out how and why our flip algorithms are getting into trouble, but may require more focused processes or changes in our algorithms. We have thus far been able to show that many triangulations with weighted vertices can become Delaunay after a series of flips, and we think that this is encouraging progress as this topic in Mathematics receives more attention. 
